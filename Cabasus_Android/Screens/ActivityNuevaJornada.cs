...
{
    [Activity(Theme = "@style/Theme.AppCompat.Light.NoActionBar", Label = "ActivityNuevaJornada")]
    public class ActivityNuecaJornada : BaseActivity, IDialogInterfaceOnClickListener
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_nueva_jornada);
            ...
            HorizontalInfiniteCycleViewPager cycleViewPager = FindViewById<HorizontalInfiniteCycleViewPager>(Resource.Id.horizontal_viewPager_nj);
            ...
            var ImagenUsuario = FindViewById<ImageView>(Resource.Id.imgUsuarioJornada);
            ...
            var NombreUsuario = FindViewById<TextView>(Resource.Id.lblNombreUserJornada);
            NombreUsuario.Text = new ShareInside().ConsultarDatosUsuario()[0].username;
            var Fecha = FindViewById<TextView>(Resource.Id.lblFechaDiaJornada);
            Date = this.Intent.GetStringExtra("Date");
            Fecha.Text = Date;
            #endregion

            #region Cancelar
            var btnCancel = FindViewById<TextView>(Resource.Id.btnCancelJornada);
            ...
            var btnFeliz = FindViewById<ImageView>(Resource.Id.imgFelizJornada);
            var btnNormal = FindViewById<ImageView>(Resource.Id.imgNormalJornada);
            var btnTriste = FindViewById<ImageView>(Resource.Id.imgTristeJornada);
            ...
            #region Descripcion
            var txtComentario = FindViewById<EditText>(Resource.Id.txtCpmentarioJornada);
            ...
            #region Fotos
            Foto1 = FindViewById<ImageView>(Resource.Id.Foto1Jornada);
            Foto2 = FindViewById<ImageView>(Resource.Id.Foto2Jornada);
            Foto3 = FindViewById<ImageView>(Resource.Id.Foto3Jornada);
            ...
            if (ActualizarDiario)
            {
                ...
                try
                {
                    ...
                    var ConsultaJornadas = con.Query<DiarioLocal>("select * from diarys where id_diary = " + id_diario + ";", (new DiarioLocal()).id_diary);

                    Fecha.Text = ConsultaJornadas[0].dates;
                    if (ConsultaJornadas[0].estado_caballo == "1")
                    {
                        EstadoDelCaballo = 1;
                        btnFeliz.Background = null;
                        btnNormal.Background = null;
                    ...
                    else if (ConsultaJornadas[0].estado_caballo == "2")
                    {
                        EstadoDelCaballo = 2;
                        btnFeliz.Background = null;
                        btnNormal.Background = null;
                    ...
                    txtComentario.Text = ConsultaJornadas[0].descripcion;

                    byte[] imageAsBytesFoto1 = Base64.Decode(ConsultaJornadas[0].foto1, Base64Flags.Default);
                    ...
                    byte[] imageAsBytesFoto2 = Base64.Decode(ConsultaJornadas[0].foto2, Base64Flags.Default);
                    ...
                    byte[] imageAsBytesFoto3 = Base64.Decode(ConsultaJornadas[0].foto3, Base64Flags.Default);
            ...
            #region Guardar
            var btnDone = FindViewById<TextView>(Resource.Id.btnDoneJornada);
            btnDone.Click += async delegate {
                ...
                FindViewById<RelativeLayout>(Resource.Id.FondoNuevaJornada).AddView(progressBar, p);
                ...
                if (txtComentario.Text.Trim().Equals(""))
                {
                    ...
                    Toast.MakeText(this, Resource.String.description_saving_journal, ToastLength.Short).Show();
                }
                else
                {
        ...
        private void StartCropActivity(Uri uri)
        {
            ...
            options.SetToolbarColor(Color.Rgb(197, 152, 6));
        ...
        private void HandleCropResult(Intent result)
        {
            ...
            if (resultUri != null)
            {
                ...
                resizedBitmap = (new ShareInside()).RedondearbitmapImagen(resizedBitmap, (new ShareInside().ConvertPixelsToDp(35, Resources.DisplayMetrics.Density)));
    ...
    public class ActualizarJornada
    {
